...
BraTS Challenge datasets collector
"""
...
class BraTSCollector(DataCollectorBase):
    ...
    def __init__(self, **kwargs):
        ...
        # BraTS API endpoints
        self.base_url = "https://www.med.upenn.edu/sbia/brats2018/api"
        self.api_url = "https://www.med.upenn.edu/sbia/brats2018/api/v1"
        
        # BraTS data types
        self.data_types = {
            "brain_mri_images": "Brain MRI Images",
            "tumor_segmentation": "Tumor Segmentation",
    ...
    def _setup_authentication(self):
        """Setup BraTS API authentication."""
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available BraTS datasets."""
        datasets = []
        ...
        try:
            ...
            for data_type, description in self.data_types.items():
                datasets.append({
                    "id": f"BRATS-{data_type}",
                    "name": f"BraTS {description}",
    ...
    def collect_data(self, 
        ...
        return dispatch_public_collect(self, "brats", data_type, **kwargs)
